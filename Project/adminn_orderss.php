...
if(isset($_GET['delete'])){
   ...
   mysqli_query($conn, "DELETE FROM `orderss` WHERE id = '$delete_id'") or die('query failed');
   header('location:adminn_orderss.php');
}
...
<section class="orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Total price : <span>OR<?php echo $fetch_orders['total_price']; ?>/-</span> </p>
         ...
         <form action="" method="post">
            ...
            <a href="adminn_orderss.php?delete=<?php echo $fetch_orders['id']; ?>" onclick="return confirm('delete this order?');" class="delete-btn">Delete</a>
         </form>
      </div>
      <?php
         }
